...
function Header({ setSearchValue, searchValue, products, openFilter }) {
  ...
  return (
    <header className="sticky top-0 z-50 sm:static">
      {!openSearchBar && (
        <div className="top-header pb-2 flex items-center p-1 flex-grow py-2">
          ...
          />
            ...
            />
           {!openSearchBar && searchTerm?.length > 0 &&
          ...
          <div className="text-white flex items-center text-sm font-medium space-x-6 mx-3 md:mx-6 whitespace-nowrap">
            ...
            <div className="block sm:hidden" onClick={() => setOpenSearchBar(true)}>
